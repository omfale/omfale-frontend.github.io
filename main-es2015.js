...
/* harmony import */ var _httpservice_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../httpservice.service */ "./src/app/httpservice.service.ts");
...
/* harmony import */ var _update_emp_update_emp_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./update-emp/update-emp.component */ "./src/app/update-emp/update-emp.component.ts");
...
/* harmony import */ var _update_emp_update_emp_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./update-emp/update-emp.component */ "./src/app/update-emp/update-emp.component.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./login/login.component */ "./src/app/login/login.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
/* harmony import */ var _httpservice_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./httpservice.service */ "./src/app/httpservice.service.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _add_employee_add_employee_component__WEBPACK_IMPORTED_MODULE_6__["AddEmployeeComponent"],
            _update_emp_update_emp_component__WEBPACK_IMPORTED_MODULE_7__["UpdateEmpComponent"],
...
let UpdateEmpComponent = class UpdateEmpComponent {
    constructor(service, router, routes) {
        this.service = service;
        this.router = router;
        this.routes = routes;
        this.list = [];
    ...
    onfinalupdate() {
        ...
        this.service.PostDataUpdate(obj)
            .subscribe((response) => {
            this.router.navigate(["/home"]);
            console.log(response);
            // this.getAllEmp();
...
module.exports = __webpack_require__(/*! E:\Mindbowser\mind-b\src\main.ts */"./src/main.ts");
